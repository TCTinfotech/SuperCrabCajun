      ...
      <div className="container about-preview-container">
        ...
        <div className="about-preview-text-side reveal reveal-delay-1">
          ...
          <p className="preview-story text-white">
            Super Crab first opened after our founders fell in love with <Link to="/menu?cat=seafood-boil" className="text-highlight-red">seafood boil</Link>. Our founders realized that they had an opportunity to improve upon the flavor they loved.
          </p>
          <p className="preview-story text-white">
            After a year of experimenting with spices and seasonings from all over the world, they finally found the perfect combination that would give Super Crab its signature flavor...
          </p>
