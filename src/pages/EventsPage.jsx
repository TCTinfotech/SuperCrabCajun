  ...
  return (
    <div className="events-page">
      <SEOHead 
        ...
        description="Host your next event with Super Crab. We offer crawfish boil catering, VIP crab banquets, corporate setups, and private restaurant rentals."
        canonicalUrl="/events"
      />

      {/* Hero Header */}
      <section className="events-hero-banner" style={{ backgroundImage: `linear-gradient(rgba(10, 14, 23, 0.45), rgba(10, 14, 23, 0.8)), url('/images/restaurant.webp')` }}>
